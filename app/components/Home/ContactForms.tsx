...
const SuccessMessage: React.FC<SuccessMessageProps> = ({ title, body, note }) => (
  <motion.div
    ...
    className="mx-auto mt-10 max-w-screen-md border border-gray-200 bg-white p-6 text-center shadow-lg"
  >
    <svg
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                className="block w-full border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 shadow-sm focus:border-[#0bbfe0] focus:ring-[#0bbfe0] dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-[#0bbfe0] dark:focus:ring-[#0bbfe0]"
            ...
            <div>
              ...
              <input
                ...
                className="block w-full border border-gray-300 bg-gray-50 p-3 text-sm text-gray-900 shadow-sm focus:border-[#0bbfe0] focus:ring-[#0bbfe0] dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-[#0bbfe0] dark:focus:ring-[#0bbfe0]"
            ...
            <button
              ...
              className="relative whitespace-nowrap bg-[#08778c] px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-[#0f5f70] focus:outline-none focus:ring-4 focus:ring-[#67e8f9] active:translate-y-px dark:bg-white dark:text-black dark:hover:bg-[#0f5f70] dark:focus:ring-[#0f5f70]"
            >
