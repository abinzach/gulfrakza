...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4 py-12 dark:bg-gray-900">
      ...
      >
        <h1 className="mb-4 text-4xl font-bold text-[#08778c] md:text-5xl">{t("title")}</h1>
        ...
        >
          <Button
            variant="outline"
            onClick={() => router.back()}
            className="rounded-full border-[#0899b4] bg-white text-[#08778c] hover:bg-gray-100 dark:bg-white"
          >
            {t("back")}
          </Button>
          <Link href="/">
            <Button className="rounded-full bg-[#08778c] hover:bg-[#0f5f70]">{t("cta")}</Button>
          </Link>
        </motion.div>
      </motion.div>
    </div>
